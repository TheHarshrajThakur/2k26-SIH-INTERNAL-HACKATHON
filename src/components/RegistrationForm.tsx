  ...
  return (
    <section id="registration" className="py-16 bg-slate-50 border-b border-slate-200 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="bg-white border border-slate-200/80 rounded-2xl p-8 sm:p-12 shadow-xl max-w-2xl mx-auto space-y-6 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border-t-4 border-t-orange-500 animate-glow">
          
          <div className="w-14 h-14 bg-gradient-to-br from-orange-500 to-amber-500 text-white rounded-2xl flex items-center justify-center mx-auto shadow-md transform hover:rotate-6 transition-transform">
            <Landmark className="w-7 h-7" />
          </div>

          <div className="space-y-2">
            <span className="text-[10px] font-extrabold text-orange-600 bg-orange-50 border border-orange-100 px-3 py-1 rounded-full uppercase tracking-wider">
